...
print ("2. Transfer")
print ("3. Internet")
print ("4. Bill and Utility")
print ("5. Airtime")

serv = str(input(": "))
if serv == "1" or serv == "Account Opening":
    print("kindly follow the proceedor below to open an account with us.")
    # OPENING ACCOUNT
    ...
    int(input("NIN: ")),int(input("Phone Number: "))
...
if provider == "1" or provider == "MTN":
    ...
    two5_gb_for_a_3MONTH = 450000
    seventyfive_gb_for_a_month = 16000
    print("1. 2000GB FOR 1 YEAR \n2. 1000GB FOR 1 YEAR \n3. 400GB FOR 1 YEAR \n4. 250GB FOR 3 MONTHS \n5. 75GB FOR A MONTH")
    package = (input("Enter gig from the above: "))
    if package == "2000GB":
        print(f"Your payment for this package is N{twoK_gb_for_a_year}")
    elif package == "1000GB":
    ...
    two5_gb_for_a_3MONTH = 40000
    seventyfive_gb_for_a_month = 14000
    print("1. 2100GB FOR 1 YEAR \n2. 1100GB FOR 1 YEAR \n3. 500GB FOR 1 YEAR \n4. 350GB FOR 3 MONTHS \n5. 85GB FOR A MONTH")
    package = (input("Enter gig from the above: "))
    if package == "2100GB":
        print(f"Your payment for this package is N{twoK_gb_for_a_year}")
    elif package == "1100GB":
...
print(f"We are pleased to inform you that your account has been successfully created. \nYour account number is:{acctnm} \nAccount Name:{Surname} {Name}")
print("Congratulations")
>>>>>>> c9f4dbfa8cbcaf65d8145cfa8eeaba2d000da7ce
